...
export const TOTEM_EFFECT_INFO: Record<string, { label: string; battle: boolean; stack: 'mult' | 'add'; format: 'mult' | 'pct' | 'flat' | 'hours' }> = {
  ...
  tapCritChance:         { label: 'Tap Crit Chance',    battle: true,  stack: 'add',  format: 'pct' },
  tapCritMultBonus:      { label: 'Tap Crit Mult',      battle: true,  stack: 'add',  format: 'flat' },
  apexOrboDamageMult:    { label: 'Apex Orbo Damage',   battle: true,  stack: 'mult', format: 'mult' },
  apexOrboCritChance:    { label: 'Apex Crit Chance',   battle: true,  stack: 'add',  format: 'pct' },
  apexOrboCritMult:      { label: 'Apex Crit Mult',     battle: true,  stack: 'add',  format: 'flat' },
  runtOrboDamageMult:    { label: 'Runt Orbo Damage',   battle: true,  stack: 'mult', format: 'mult' },
  runtOrboCritChance:    { label: 'Runt Crit Chance',   battle: true,  stack: 'add',  format: 'pct' },
  runtOrboCritMult:      { label: 'Runt Crit Mult',     battle: true,  stack: 'add',  format: 'flat' },
